...
export function SettingsPage({ onLogout }: SettingsPageProps) {
  const { user, updateUser, logout, walletAddress } = useAuth();
            ...
            <CardBody className="space-y-6">
              ...
              <FormGroup>
                <Input
                  ...
                  hint="Google manages authentication; ShieldPass does not receive your password."
                />
              </FormGroup>
            </CardBody>
            ...
            <div>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                <div>
                  ...
                  <p className="max-w-sm break-all text-sm text-gray-600 dark:text-gray-400">
                    {walletAddress || 'Sui address is loading…'}
                  </p>
                </div>
